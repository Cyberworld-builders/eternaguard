        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <a href="/demo/mockups" className="text-slate-600 hover:text-emerald-600 transition-colors">
                Mockups
              </a>
              <a href="/demo/cms-dashboard" className="text-slate-600 hover:text-emerald-600 transition-colors">
                CMS
              </a>
              <a href="/demo/crm-dashboard" className="text-slate-600 hover:text-emerald-600 transition-colors">
                CRM
              </a>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-md border border-slate-200 hover:border-emerald-300 transition-colors">
              ...
              <a href="/demo/cms-dashboard" className="text-emerald-600 hover:text-emerald-700 font-semibold text-sm inline-flex items-center">
                View Demo Dashboard →
              </a>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-md border border-slate-200 hover:border-emerald-300 transition-colors">
              ...
              <a href="/demo/crm-dashboard" className="text-emerald-600 hover:text-emerald-700 font-semibold text-sm inline-flex items-center">
                View Demo Dashboard →
              </a>
            </div>
